package com.coolbeevip.benchmark.iotdb.devices;


import com.coolbeevip.benchmark.iotdb.core.DeviceBuilder;
...
public class CardDevice extends DeviceEntity {
  ...
  public static final class Builder extends DeviceBuilder {
